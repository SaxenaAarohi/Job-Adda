...
export default function Header() {
    ...
    return (
        <div className="h-15 bg-gray-900 text-black py-1 flex justify-between px-4">
            ...
            <div>
                <img className="h-[30px] mt-3 md:h-[40px] w-16 md:w-20 "
            ...
            <div className="flex relative">
                ...
                <input type="text"
                    value={query}
                    className="md:w-[500px] w-[200px] border bg-gray-300 h-8 my-2 p-2"
        ...
        <div className="absolute right-4 top-10 mt-2 w-32 bg-gray-300 rounded-lg shadow-lg flex flex-col z-40 space-y-2 p-3 md:hidden">
          {
            ...
            <div className="md:flex hidden gap-5 text-4xl text-white py-2">
                {
                    user?.user?.role === "admin" ?
                        (!user.company
